...
/**
 * A DocumentFilter that allows you to control the maximum number of characters
 * that can be added to the Document. When the Document is full you can
 * optionally tab to the next component to speed data entry.
 *
 * This class can also be used as a generic size filter for JTextFields. In this
 * case when a size of 0 is speicifed for the size of the Document the
...
public class SizeDocumentFilter extends ChainedDocumentFilter {
	...
	/**
	 * Constructor to set the size for this filter as well as provide additional
	 * filtering
	 *
	 * @param size
	 *            maximum number of characters to be added to the Document
	...
	/**
	 * Make sure the insertion of text will not cause the Document to exceed its
	 * size limit. Also, potentially tab to next component when full.
	 */
	@Override
	 ...
	 * obtained from the associated text field. Otherwise, use the class size
	 * property.
	 */
